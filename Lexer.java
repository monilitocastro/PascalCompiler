/**
 * CSCI 465
 * This class allows for token by token scanning. It does this by keeping
 * an ever decreasing class-level string for the source. The largest possible
 * token is consumed. Patterns which are added have greater rank than the
 * patters below.
...
public class Lexer {
 ...
 public TokenListElement nextToken(){
  return _tokenizer.nextToken();
 }

 public Hashtable <String, LinkedList<SymbolAttributes>> getSymbolTable(){
  return _tokenizer.getSymbolTable();
 }
 /**
 * Adds all the tokens starting with most important first.
 * @param  source file
 */
 ...
 /**
  * Testing method for Tokenizer class. Formerly the main method.
  * @param 
  */
 public void FirstDelivery(String[] args) {
  for(String s : args){
   System.out.println("\n***************************************************************");
   System.out.println(  "*                   Second Delivery Tokens                    *");
   System.out.println(  "***************************************************************\n");
   String source;
   try{
