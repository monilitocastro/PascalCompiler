...
public class Tokenizer2 {
 ...
 public TokenListElement nextToken(){
  if(source==null){
   System.out.println("Source pointer is null. Exiting.");
   System.exit(0);
  }
  if(patterns.isEmpty()){
   ...
   */
    ...
    */
    ...
    //System.out.println("Parser preimage: "+ image);
   ...
   elemToAdd = new TokenListElement("", "$");
  }
  return elemToAdd;
 }
 ...
 public void addToSymbolTable(String name, String token, int index){
  ...
  //}
  //System.out.println("Adding to SYMBOLTABLE: "+name);
  if(isAssigningValue){
 ...
 public void assignAllSymbolStack(String tknType){
  //System.out.println("****************Assigning all to stack of type "+tknType);
